...
app.Animation = (function () {
	...
	function initialize() {
        ...
        t.set(mug, {x:160, y:92});
        t.set(txt1, {opacity:0});
        t.set(txt2, {opacity:0});
        t.set(lockup, {x:-2, opacity:0});
        t.set(cta, {opacity:0});
        t.set(pod, {scale:1.3, x:-23, y:455});
	...
	function start() {
        ...
        tl1.to(pod, .5, {scale:.9, y:"-=6", x:"-=1", ease: "myBounce" }, "+=.5")
        ...
        .to(mug, 1, {x:-54, ease: Power4.easeOut})
